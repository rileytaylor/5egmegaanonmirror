...
function usemonster (id) {
	...
	$("th#name").html("<span title=\""+origsource+"\" class='source source"+source+"'>"+source+"<br></span> <a href='static/img/"+source+"/"+name+".png' target='_blank'><img src='static/img/"+source+"/"+name+".png' class='token' onerror='imgError(this)'></a>"+name);
